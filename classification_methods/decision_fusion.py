...
print(mm,nn,zz)
#print(classification_report(Y_test,X1_pre))
#print(classification_report(Y_test,X2_pre))
#weight
...
for i1 in range(lenth):
    for i2 in range(lenth):
        for i3 in range(lenth):
            for i4 in range(lenth):
                for i5 in range(lenth):
                    count = 0
                    weight = [[w[i1],w[i2],w[i3],w[i4],w[i5]],[1-w[i1],1-w[i2],1-w[i3],1-w[i4],1-w[i5]]]
                    for i in range(zz):
                        for k in range(nn):
