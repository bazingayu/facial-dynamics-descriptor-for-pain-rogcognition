...
max_weight1 = []
for ii in range(5):
    X1_train, X1_test, X2_train, X2_test, X3_train, X3_test, X4_train, X4_test, X5_train, X5_test, Y_train, Y_test = train_test_split(X1,X2,X3,X4,X5,Y1,test_size=0.2)
...
for train_n , test_n in kf.split(X1):
    ...
    decision_matrix = []
    clf11 = RandomForestClassifier(n_jobs=-1,n_estimators=100)
    ...
    clf22 = RandomForestClassifier(n_jobs=-1,n_estimators=100)
    ...
    clf33 = RandomForestClassifier(n_jobs=-1, n_estimators=100)
    ...
    clf55 = RandomForestClassifier(n_jobs=-1, n_estimators=100)
