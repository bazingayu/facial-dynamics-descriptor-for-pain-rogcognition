...
label1 = [0,4],[4,0],[4,1],[1,4],[4,2],[2,4],[4,3],[3,4],[3,0],[0,3],[3,1],[1,3],[3,2],[2,3],[2,0],[0,2],[2,1],[1,2],[1,0],[0,1]
for iiii in range(len(label1)):
    label = label1[iiii]
    print(label)
    ...
    for ii in range(5):
        ...
        '''
        result = [0.1,0.9],[0,1],[0.2,0.8],[0.3,0.7],[0.4,0.6],[0.5,0.5],[0.6,0.4],[0.7,0.3],[0.8,0.2],[0.9,0.1],[1,0]
        ...
        for i in range(len(deter)):
            ...
            #print(np.shape(weight), np.shape(decision_matrix))
            #print(zz,nn)
            for i in range(zz):
                for k in range(nn):
    ...
    for train_n , test_n in kf.split(X1):
        ...
        #print(fpr1,tpr1)
        plt.plot( fpr1,tpr1,linewidth = '1',label=u'distance',color = '#ADD8E6',linestyle='-')'''
        ...
        plt.plot(fpr2, tpr2, linewidth='1', label=u'gradient', color='#6495ED', linestyle='-')
        ...
        plt.plot(fpr3, tpr3, linewidth='1', label=u'head pose', color='#00008B', linestyle='-')
        ...
        plt.plot(fpr4, tpr4, linewidth='1', label=u'biomedical signals', color='#0000CD', linestyle='-')
        ...
        plt.plot(fpr5, tpr5, linewidth='1', label=u'sequence Gabor', color='#8A2BE2', linestyle='-')
        ...
        plt.plot(fpr6, tpr6, linewidth='1', label=u'decision fusion', color='red', linestyle='-')
        plt.show()
        ...
        final_result4.append(count5 / zz)
        #final_result5.append(count5 / zz)
        final_result.append(count / zz)
    #print(final_result1,final_result2,final_result3,final_result4,final_result)
    scores = classification_report(Y_test1, y_pred1, digits=3)
    #print(scores)
    print(np.mean(final_result2),np.mean(final_result4),\
